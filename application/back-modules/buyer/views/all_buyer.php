                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <div class="input-group input-group-sm" style="width: 150px;">
                                <input type="text" id="search" placeholder="Search buyer" autocomplete="on" onkeyup="javascript: ajax_fun('<?php echo base_url(); ?>buyer/allBuyerListing')" class="form-control pull-right" >
...
<script type="text/javascript">
    ajax_fun('<?php echo base_url()."buyer/allBuyerListing/".$page; ?>');
