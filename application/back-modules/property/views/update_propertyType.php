...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Property Type</li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <form method="post" action="" role="form">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="typeName" value="<?php echo $pType->typeName; ?>" class="form-control" id="exampleInputEmail1" >
                            </div>
                            
                        </div>
                        <!-- /.box-body -->
                        <div class="box-footer">
                            <button type="submit" class="btn bg-olive margin">Update</button>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
