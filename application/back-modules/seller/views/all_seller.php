        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    You want to delete this seller?
                </div>
                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <div class="input-group input-group-sm" style="width: 150px;">
                                <input type="text" id="search" placeholder="Search seller" autocomplete="on" onkeyup="javascript: ajax_fun('<?php echo base_url(); ?>seller/allSellerListing')" class="form-control pull-right" >
...
<script type="text/javascript">
    ajax_fun('<?php echo base_url()."seller/allSellerListing/".$page; ?>');
