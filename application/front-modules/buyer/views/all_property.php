...
<section class="MypropertySec sec-pad gray-bg">
    <div class="container">
    	<div class="mainHead mb-5 Hcenter">
			<h2>Search  <span>Properties</span></h2>
			<div class="at-heading-under-line lCenter">
	            <div class="at-heading-inside-line"></div>
	        </div>
	        <p>“Browse available property listings.” New properties are fixed price while other properties are open for bidding at a certain time.</p>
		</div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <?php if(!empty($error)){?>
                    ...
                    <?php endif; ?> 
                    <?php if($this->session->flashdata('successAlert') == '22') :?>  <!-- for Delete -->
                        <script type="text/javascript">
                            swal("Congratulations !", "You have reserved this property. We are reviewing your order and will contact you by email.", "success");
                        </script>
                    <?php endif; ?>
...
<script type="text/javascript">
	...
	ajax_fun('<?php echo base_url()."buyer/allPropertyList/".$page; ?>');
