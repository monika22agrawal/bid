							...
							<div class="property_price property_main-item">
								...
								<?php if($this->session->userdata('front_login') == true && $this->session->userdata('id') != ''){ 
	              				...
	              				<ul class="property_details_ic list-inline">
	                                <li><i class="fa fa-object-group" aria-hidden="true"></i> <?php echo $details->area.' m<sup>2</sup>'; ?> </li>
						...
						<div class="col-lg-3 col-md-12 col-sm-12 vcenter">
							...
							<?php if($this->session->userdata('front_login') == true){
										...
										<?php }elseif(($details->bankStatement == '')){ 
												...
												<?php } }elseif(!empty($details->bankStatement) && empty($details->proofOfFund) && empty($details->EOI) && $details->status == 1 && $details->isApproved == 1){ ?>
													...
													<?php } elseif(!empty($details->bankStatement) && empty($details->proofOfFund) && empty($details->EOI) && $details->isApproved == 0){ ?>

														<a href="javascript:void(0);" class="btn btn-theme">Wait For Approval</a>

													<?php } elseif(!empty($details->bankStatement) && empty($details->proofOfFund) && empty($details->EOI) && $details->isApproved == 2){ ?> 

														<a href="javascript:void(0);" class="btn btn-theme">Bank statement not approved</a>
	    				...
	    				<div class="property-content">
							...
							<div class="property-section property-overview">
								...
								<ul class="columns-gap">
									...
									<li><span>Area:</span> <?php echo $details->area.' m<sup>2</sup>'; ?></li>
							...
							if($details->propertyStatus == '2'){ 
								if(!empty($details->evaluationReport)){ 
									...
									<?php }else{ ?>
										...
										<div class="doc">
											<h2 class="float-left">Valuation Report</h2>
											<a href="<?php echo base_url('buyer/orderPayment/').$details->id;?>" class="btn btn-theme float-right">Please Pay for Download Document</a>
