<?php if(!empty($soldProperty)){ foreach ($soldProperty as $get) { ?>
<div class="col-lg-6 col-md-6">
    <div class="at-property-item mb-4 <?php echo ($get['propertyStatus'] == '2') ? 'OldPr' : '' ?>">
        <div class="at-property-img">
            ...
            <a class="btn btn-default at-property-btn" href="<?php echo base_url('seller/viewProperty/').$get['propertyId'];?>" role="button">View Details</a> 
            <?php if($get['isSold'] == '1'){ ?>
                <h4>Sold</h4> 
            <?php } ?>
        ...
        <div class="at-property-location">
            <h3><a href="<?php echo base_url('seller/viewProperty/').$get['propertyId'];?>"><?php echo ucwords($get['propertyName']);?></a></h3>
...
<?php } } else{ echo "<div class='notFound'><h3>No Sold Property</h3></div>"?>           
<?php } ?>      
<div class="pagCustom">    
    <?php echo $links; ?> 
</div>
