					...
					<div class="EditInfo CSForm">
						...
						<div class="tab-content">
						  <div class="tab-pane active" id="Info" role="tabpanel">
						  	...
						  	<form id="updateProfile" action="<?php echo base_url();?>seller/editProfile" method="POST"  enctype="multipart/form-data">
								<!-- <div class="prImg">
			                		<div class="log_div">
			                          	<img src="<?php echo $seller->profileImage; ?>" id="pImg">
			                	...
			                	<div class="row">
			                		<div class="col-md-6 col-sm-12">
					                    ...
					                    <div class="inner-wrap">
					                        <input type="text" name="name" value="<?php echo isset($seller->name) ? $seller->name : ''; ?>" required title="Please enter full name"/>
					                    </div>
			                		</div>
			                		<div class="col-md-6 col-sm-12">
			                			<div class="section">Mobile Number</div>
					                    <div class="inner-wrap">
					                        <input type="text" name="contactNo" value="<?php echo isset($seller->contactNo) ? $seller->contactNo : ''; ?>" required title="Please enter mobile number"/>
					                    </div>
			                		</div>
			                	</div> 
...
<script type="text/javascript">
    ...
    $("#updateProfile").validate({
        rules:
        {
            contactNo:{required:true,number:true,minlength: 7,maxlength:12,remote:"<?php echo base_url('seller/checkCNO');?>"}
        },
        messages: {
    ...
    $('.chngPwd').click(function(){
        ...
        if(flag){
	        ...
	        $.ajax({ 
	            url: '<?php echo base_url();?>seller/changePassword',
