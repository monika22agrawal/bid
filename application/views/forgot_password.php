...
<html>
	<head>
		...
		<title>BidHome Forgot Password</title>
...
<body style="font-family: 'Roboto', sans-serif; padding:0; margin:0;">
	...
	<tr>
		<td style="text-align: center;">
			...
			<tr>
			<td>
				<p style="text-align: center;">Dear BidHome Member,</p>
				<p style="text-align: center;">We got a request of forgot password. As requested, here is your bidhome password.</p>
				...
				<!-- <p style="color: #333; font-size: 16px; line-height: 28px;">We got a request of forgot password.
				As requested, here is your bidhome password.</p> -->
				<h2 style="background: #62a0b9; color: #fff; margin: 15px 0 5px; font-size: 30px; display: inline-block; font-weight: normal; padding: 10px 15px;"><?php echo $password;?></h2>
			</td>
			</tr>
		</table>
		</td>
