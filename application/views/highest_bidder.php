...
<html>
	<head>
	    ...
	    <title>Highest Bidder Email</title>
					...
					<table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
						<tr>
							<td>
								...
								<h3 style="color: #333; font-size: 28px; font-weight: normal; margin: 0; text-transform: capitalize;">Hello <?php echo ucfirst($name);?> Highest Bidder</h3>
								<p style="color: #333; font-size: 16px; line-height: 28px;">Congratulations,  We are  very greatful that you are participate in bidhome. You are the highest bidder for <?php echo ucfirst($propertyName);?> property , we assign this property to you. Now we will let you know further process of this property.</p>
